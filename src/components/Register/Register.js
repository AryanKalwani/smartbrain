...
class Register extends React.Component {
	...
	onSubmitSignIn = () => {
		fetch('https://secure-hollows-62423.herokuapp.com/register',{
			method: 'post',
		...
		<article className="br3 ba --black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
			<main className="pa4 black-80">
			  <div className="measure">
			    ...
			    { this.state.var ? <p className="f3 black">Looks like your name or email has already been taken. Please try again.</p> : null}
			  </div>
			</main>
		</article>
	); 
